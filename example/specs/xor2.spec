#	$Id: xor2.spec,v 1.4 1999/06/08 14:43:36 ryu Exp $
...
$celldata{"$cellname:cellprop:cell_footprint"}		= q/"xor2"/;
$celldata{"$cellname:termprop:out:function"}		= q/"(in0 in1' + in0' in1)"/;
