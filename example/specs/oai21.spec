#	$Id: oai21.spec,v 1.4 1999/06/08 14:43:36 ryu Exp $
...
$celldata{"$cellname:cellprop:cell_footprint"}		= q/"oai21"/;
...
&autochar ('inverting', 'in10', 'out', tie_high, 'in0');
&autochar ('inverting', 'in11', 'out', tie_high, 'in0');
