#	$Id: nor3.spec,v 1.4 1999/06/08 14:43:36 ryu Exp $
...
$celldata{"$cellname:cellprop:cell_footprint"}		= q/"nor3"/;
...
&autochar ('inverting', 'in1', 'out', tie_low, '.*');
&autochar ('inverting', 'in2', 'out', tie_low, '.*');
