#	$Id: aoi22.spec,v 1.5 1999/06/08 14:43:36 ryu Exp $
...
$celldata{"$cellname:cellprop:cell_footprint"}		= q/"aoi22"/;
...
&autochar ('inverting', 'in00', 'out', tie_high, 'in01');
&autochar ('inverting', 'in01', 'out', tie_high, 'in00');
