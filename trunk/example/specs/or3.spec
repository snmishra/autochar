#	$Id: or3.spec,v 1.4 1999/06/08 14:43:36 ryu Exp $
...
$celldata{"$cellname:cellprop:cell_footprint"}		= q/"or3"/;
$celldata{"$cellname:termprop:out:function"}		= q/"(in0 + in1 + in2)"/;
...
&autochar ('non_inverting', 'in0', 'out', tie_low, '.*');
&autochar ('non_inverting', 'in1', 'out', tie_low, '.*');
&autochar ('non_inverting', 'in2', 'out', tie_low, '.*');
