#	$Id: clock_gate.spec,v 1.2 2000/01/07 06:01:10 ryu Exp $
...
#------	GATED CLOCK ENABLE SETUP/HOLD TIME CHARACTERIZATION --------------------------
...
#	&autochar ( <cetype>, <ce>, <clktype>, <clk>, <clkouttype>, <clkout>, <ctype>, <c>,
#		[ <tie>, <unused>+] );
#
...
#	<clkouttype>	= either 'inverting' or 'non_inverting' w.r.t. clk
#	<clkout>	= name of the flop data output term
#	<ctype>		= either 'inverting' or 'non_inverting' w.r.t. clk
